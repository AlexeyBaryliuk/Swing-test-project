...
public class GroupLayoutTest extends JFrame
{
    ...
    public GroupLayoutTest()
    {
        ...
        JCheckBox   cbCaseSensitive = new JCheckBox("cbCaseSensitive");
        JCheckBox   cbWholeWords    = new JCheckBox("cbWholeWords "  );
        JCheckBox   cbBackward      = new JCheckBox("cbBackward  "  );
        JButton     btnFind         = new JButton("btnFind"   );
